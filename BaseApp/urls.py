...
urlpatterns = [
    ...
    path('post_view/<slug:post_view_slug>/', cache_page(15)(PostDetailView.as_view()), name='post_view'),
    ...
    path('user_posts/', cache_page(60)(UserPosts.as_view()), name='user_posts'),
    ...
    path('rated_posts/', cache_page(60)(RatedPages.as_view()), name='rated_posts'),
]
